...
% Adjust these lengths to control white space around formulas
\setlength{\abovedisplayskip}{0.5\baselineskip}    % Space before display math
\setlength{\belowdisplayskip}{0.5\baselineskip}    % Space after display math
\setlength{\abovedisplayshortskip}{0.25\baselineskip}  % Space before short display
\setlength{\belowdisplayshortskip}{0.25\baselineskip}  % Space after short display
...
% CHAPTER HEADING
% \chapnamefont controls "Chapter X" label
% \chapnumfont controls the chapter number
% \chaptitlefont controls "Chapter Title" text
% Small caps (\scshape) creates visual impact without being aggressive
