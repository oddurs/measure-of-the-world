...
% The \strut in \everydisplay ensures baseline alignment
\setlength{\abovedisplayskip}{12pt}
\setlength{\belowdisplayskip}{12pt}
\setlength{\abovedisplayshortskip}{12pt}
\setlength{\belowdisplayshortskip}{12pt}

% Consistent formula heights: add invisible vertical strut to every display
% This prevents formulas with different content heights from looking misaligned
\everydisplay{\displaystyle\strut}
