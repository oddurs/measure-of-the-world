...
\geometry{%
  ...
  inner=1.625in,              % Inner margin (gutter): 1.75 inches
  outer=1.375in,               % Outer margin: 1.5 inches
  top=1.375in,                 % Top margin: 1.5 inches
  bottom=1.625in,             % Bottom margin: 1.75 inches
...
% --------- TABLE TEXT SIZING ---------
% Body text size for table content (10pt for compact tables)
\newcommand{\tabletextsize}{\fontsize{10}{12}\selectfont}
...
% Body: 12pt with 15pt leading (1.25×) → Caption: 10pt with 12.5pt leading
\newcommand{\captionformat}{\fontsize{10}{12.5}\selectfont}
