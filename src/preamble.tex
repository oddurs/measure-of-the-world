...
% Master variable: adjust this single length to globally control spacing around
% all display math formulas. Roughly equivalent to:
%   0.5\baselineskip = minimal spacing
%   1\baselineskip = single blank line
%   1.5\baselineskip = 1.5 blank lines
%   2\baselineskip = double blank line (two carriage returns)
% EDIT THIS VALUE TO ADJUST ALL MATH SPACING AT ONCE:
\newlength{\displaymathspacing}
\setlength{\displaymathspacing}{1.25\baselineskip}
...
% Spacing before and after display math environments
% These use the global spacing length defined above for consistency
\setlength{\abovedisplayskip}{\displaymathspacing}    % Space before display math
\setlength{\belowdisplayskip}{\displaymathspacing}    % Space after display math
\setlength{\abovedisplayshortskip}{0.75\displaymathspacing}  % Space before short display (75% of main)
\setlength{\belowdisplayshortskip}{0.75\displaymathspacing}  % Space after short display (75% of main)
...
% Footnote rule: thin horizontal divider between text and footnotes
% Color: dark gray (#333333), with padding above and below
\renewcommand{\footnoterule}{%
  \kern -3pt
  \color[HTML]{333333}\hrule width 2in height 0.5pt%
  \kern 2.86pt}

% Space before the first footnote (reduced from default)
\setlength{\skip\footins}{0.5\baselineskip}

% Space between individual footnotes (3pt as requested)
\setlength{\footnotesep}{3pt}

% Footnote font: slightly smaller than body text but readable
\renewcommand{\footnotesize}{\fontsize{10}{12}\selectfont}

% =====================================================================
% SECTION 19: FOOTER SPACING
% =====================================================================
% Reduce space above footer to bring it closer to body text

% Existing footskip (distance from baseline to footer): currently 0.75in
% Adjust if needed for tighter footer positioning
% (This is set in \geometry{} command in Section 1; modify there if needed)
% =====================================================================
