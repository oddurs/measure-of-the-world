...
\setlength{\beforechapskip}{10\baselineskip}
...
% Header setup for main matter pages
\makeheadrule{mainmatter}{\textwidth}{\headerrulethickness}
% Verso (left) page headers - chapter title
\makeoddhead{mainmatter}{\rectoheader{\rightmark}}{}{\footerpagenumber{\thepage}}
% Recto (right) page headers - chapter name
\makeevenhead{mainmatter}{\footerpagenumber{\thepage}}{}{\versoheader{\leftmark}}
% Footer setup - all blank
\makeoddfoot{mainmatter}{}{}{}
\makeevenfoot{mainmatter}{}{}{}

% Configure chapter marks for headers
...
\setlength{\LTpre}{1\baselineskip}
\setlength{\LTpost}{1\baselineskip}

% Table typography variables
% Body text size for table content
\newcommand{\tabletextsize}{\small}
% Row height multiplier (default 1.0)
\newcommand{\tablerowheight}{1.0}
% Column padding (left/right)
\newcommand{\tablecolumnpadding}{0.5em}
% Top/bottom rule thickness
...
\newcommand{\tableafterskip}{0.75\baselineskip}
% Caption to table spacing
\newcommand{\tablecaptionspacing}{0.5\baselineskip}
% Booktabs array column separator
