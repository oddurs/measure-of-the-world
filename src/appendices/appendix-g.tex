...
\noindent\textbf{Context}: This passage establishes Flamsteed's program of systematic observation, motivated by practical navigation concerns (longitude determination) as well as scientific rigor. His 44-year tenure at Greenwich (1675--1719) set the standard for continuous, careful observation that characterized the Observatory for centuries (Chapter 2).
