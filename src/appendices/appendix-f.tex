...
\textsc{Maskelyne, Nevil.} \emph{The British Mariner's Guide}. John Nourse, London, 1763. Maskelyne's practical treatise on the lunar distance method, presenting the step-by-step procedures for computing longitude from lunar observations. Referenced in Chapter 9's historiographical discussion of the institutional competition between chronometric and astronomical approaches to longitude-finding. Documents Maskelyne's advocacy for the lunar distance method during the period when Harrison's chronometers were under development.
