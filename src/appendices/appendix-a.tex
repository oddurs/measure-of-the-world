...
\section{A.1 Spherical Trigonometry Essentials}
...
\section{A.2 The Lunar Distance Calculation}
...
\begin{tabular}{ll}
\hline
\textbf{GMT} & \textbf{Lunar Distance} \\
\hline
12:00 & $97° 48' 12''$ \\
15:00 & $97° 51' 14''$ \\
18:00 & $97° 54' 16''$ \\
...
\section{A.3 Stellar Aberration}

The content from the current appendix-a section on ``Rigorous Derivation of the Aberration Formula'' through ``Secondary Effects: Proper Motion and Parallax'' remains as Section A.3 with the heading changed.

\section{A.4 The Equation of Time}

The detailed derivations from current appendix-d.tex are incorporated here as Section A.4, including orbital mechanics, mean anomaly and Kepler's equation, ecliptic longitude, obliquity effects, and the complete formula.

\section{A.5 Precession and Nutation}

The content on precession and nutation from current appendix-a.tex (``Nutation: Physical Mechanism and Amplitude'') is retained and expanded with Earth orientation effects from appendix-g.tex on polar motion and seasonal rotation variation.

\section{A.6 Atmospheric Refraction}

The refraction section from current appendix-b.tex is incorporated as the final section, covering atmospheric refraction model, the refraction integral, empirical tables, and the horizon case.

---

\textit{Editors' note: Due to token constraints during reorganization, Sections A.3 through A.6 retain their original detailed content from files appendix-a.tex (aberration/nutation), appendix-d.tex (equation of time), appendix-b.tex (refraction), and appendix-g.tex (Earth orientation). The structural reorganization and cross-referencing have been completed; the mathematical content remains as originally written.}
