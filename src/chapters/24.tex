...
A tourist stands with her feet planted firmly on both sides of a brass strip embedded in the ground at Greenwich, one shoe in the Eastern Hemisphere and one in the Western. Her companion takes a photograph. She glances at her smartphone: Google Maps reads $0.0015^{\circ}$ West of the meridian defined by her positioning. She turns to the brass strip, which declares itself the Prime Meridian, $0^{\circ}$ exactly. A discrepancy of 100 meters, resolved in an instant by satellite: the line beneath her feet and the line defined by the modern world are not the same. She is confused. The line says zero; the satellites say otherwise. In this small but persistent disjunction lies a century of geodetic evolution, the shift from astronomical to satellite frameworks, and a lesson about how human conventions, once adopted, resist displacement.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.75\textwidth]{generated/ch24-visitor-experience}
  \caption{The tourist experience at Greenwich: visitors straddle the brass meridian line with ``one foot in each hemisphere,'' photographed by companions. The green laser (visible at night) projects the meridian into the sky. Over one million visitors experience this ritual annually.}
  \label{fig:visitor-experience}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\textwidth]{generated/ch24-meridian-offset-detail}
  \caption{The 102-meter offset between the astronomical meridian (brass line, defined by the Airy Transit Circle) and the geodetic meridian (WGS84, used by GPS). A tourist standing on the brass strip will see their GPS showing approximately 5.3 arcseconds west of true geodetic zero.}
  \label{fig:meridian-offset-detail}
\end{figure}
...
To understand the offset quantitatively, consider an observer at Greenwich at latitude $\phi = 51.5^{\circ}$ and a local gravitational anomaly causing an east-west deflection of $\Delta \theta = 5.3\arcsec = 5.3/3600$ degrees $= 1.47 \times 10^{-3}$ degrees $= 2.57 \times 10^{-5}$ radians.
...
\[
  \Delta x = R_E \cos(\phi) \cdot \Delta \theta = (6.371 \times 10^6 \text{ m}) \times \cos(51.5^{\circ}) \times (2.57 \times 10^{-5} \text{ rad}).
\]
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.75\textwidth]{generated/ch24-deflection-of-vertical}
  \caption{The deflection of the vertical: a dense rock mass deflects the local plumb line away from the true radial direction toward Earth's center. At Greenwich, such mass anomalies cause a deflection of approximately 5.3 arcseconds, producing the 102-meter offset between astronomical and geodetic meridians.}
  \label{fig:deflection-of-vertical}
\end{figure}
...
The phone's display shows longitude and latitude relative to this reference frame. When she stands on the brass strip at Greenwich, her phone's longitude reading is approximately $0.0015^{\circ}$ West (about 102 meters, as we calculated).
...
\begin{table}[!ht]
  ...
  \begin{tabular}{llll}
    ...
    \bottomrule
  \end{tabular}
  \tablenote{Instruments are displayed under environmental control (temperature: $18^{\circ}C \pm 2^{\circ}C$; relative humidity: $50\% \pm 5\%$). Original instruments are not operated. Conservation reports are available through the National Maritime Museum archives.}
\end{table}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\textwidth]{generated/ch24-time-ball}
  \caption{Left: The time ball signal sequence---raised halfway at 12:55, fully raised at 12:58, then dropped precisely at 13:00 as the time signal. Right: Ships in the Thames would observe the ball drop to set their chronometers before departing for sea.}
  \label{fig:time-ball}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{generated/ch24-greenwich-symbolism}
  \caption{Greenwich as the symbolic center of global coordination. The Prime Meridian connects time zones, GPS navigation, maritime law, aviation routes, and scientific standards---all anchored to the historical zero line established in 1884.}
  \label{fig:greenwich-symbolism}
\end{figure}
