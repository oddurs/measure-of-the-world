...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{generated/ch17-candidate-meridians}
  \caption{The candidate prime meridians considered at the 1884 conference. Greenwich (solid line) was already used by 72\% of the world's merchant shipping. Paris, Washington, Ferro, and a ``neutral'' Atlantic meridian were proposed alternatives.}
  \label{fig:candidate-meridians}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.6\textwidth]{generated/ch17-conference-vote}
  \caption{The vote on adopting Greenwich as the prime meridian, October 13, 1884. Twenty-two nations voted in favor, one against (San Domingo), and two abstained (France and Brazil).}
  \label{fig:conference-vote}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{generated/ch17-time-zones}
  \caption{The 15-degree time zone system. Each 15° band of longitude corresponds to a one-hour offset from Greenwich (UTC). Cities at different longitudes observe local times offset by whole hours from the prime meridian.}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{generated/ch17-adoption-timeline}
  \caption{Timeline of Greenwich meridian adoption. British railways began using Greenwich time in the 1850s, decades before the 1884 conference. France adopted Greenwich time in 1911, despite its abstention at the conference.}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.65\textwidth]{generated/ch17-meridian-offset}
  \caption{The 102-meter offset between the historical prime meridian (Airy's transit circle, marked by the tourist brass line) and the modern WGS84 prime meridian used by GPS. The discrepancy arises from differences in geodetic reference frames.}
  \label{fig:meridian-offset}
\end{figure}
