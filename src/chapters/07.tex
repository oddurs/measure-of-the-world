...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{generated/ch07-prize-thresholds}
  \caption{The Longitude Act's prize structure. Left: rewards increased with tighter accuracy requirements. Right: the physical meaning of each threshold in terms of time error and angular displacement.}
  \label{fig:prize-thresholds}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{generated/ch07-competing-methods}
  \caption{Comparison of the four longitude methods across key criteria. No single approach dominated: lunar distances were theoretically sound but computationally demanding; chronometers were practical but expensive; magnetic variation was easy but unreliable; Jupiter's moons required good observing conditions rarely found at sea.}
  \label{fig:competing-methods}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{generated/ch07-board-timeline}
  \caption{Timeline of key Board of Longitude decisions, showing the interleaving of Harrison's chronometer developments (blue), lunar distance method advances (orange), and policy decisions (green).}
  \label{fig:board-timeline}
\end{figure}
