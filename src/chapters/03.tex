...
\begin{figure}[htbp]
  ...
  \caption{Uraniborg, Tycho Brahe's observatory on the island of Hven, from \emph{Astronomiae Instauratae Mechanica} (1598). The elaborate Renaissance structure combined living quarters, library, and multiple observation platforms equipped with large instruments.}
  \label{fig:uraniborg}
\end{figure}
