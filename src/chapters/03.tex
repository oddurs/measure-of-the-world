...
%   \caption{Schematic representation of the mural arc installation at Greenwich Observatory, showing the quarter-circle graduated instrument mounted in the meridian plane, with telescope attached for sighting stars at meridian crossing. The arc radius was nearly seven feet, allowing for fine division of the scale and precision measurement of stellar declinations.}
%   \label{fig:mural-arc}
% \end{figure}
...
%   \centering
%   \includegraphics[width=0.7\textwidth]{placeholder}
%   \caption{Celestial coordinate system: right ascension (RA) measured eastward from the vernal equinox along the celestial equator (analogous to longitude on Earth), and declination (Dec) measured north (+) or south (-) from the celestial equator (analogous to latitude). Flamsteed's method determined RA from clock time at meridian crossing and declination from arc altitude readings, achieving unprecedented precision in stellar positions.}
...
%   \caption{Schematic of the Tompion pendulum clock mechanism at Greenwich: 13-foot pendulum with adjustable bob for period regulation, sophisticated pivot point minimizing friction and wear, and escapement mechanism ensuring regular beat transmission to clock face. The isochronous design ensured that the period remained constant even as the initial swing amplitude decreased due to air resistance and friction, enabling accurate timekeeping over periods of hours to days.}
%   \label{fig:tompion-clock}
% \end{figure}
...
%   \centering
%   \includegraphics[width=0.75\textwidth]{placeholder}
%   \caption{Comparison of observational precision: Tycho Brahe's catalog (1600) typical errors of 1-3 arc-minutes versus Flamsteed's early observations (1690s) with errors of 10-20 arc-seconds. The improvement of 5-10 times in precision was achieved through Flamsteed's use of accurate pendulum clocks to measure right ascension from meridian crossing times, rather than relying on graduated scale divisions alone.}
%   \label{fig:precision-improvement}
% \end{figure}
