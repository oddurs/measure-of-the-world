...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\textwidth]{generated/ch25-patronage-models}
  \caption{Models of scientific patronage through Greenwich's history: royal patronage (1675--1850), imperial science during Britain's maritime dominance (1850--1950), and government funding in the modern era (1950--present). Key events mark transitions between eras.}
  \label{fig:patronage-models}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{generated/ch25-precision-evolution}
  \caption{Four centuries of improving positional precision: from 60 arcseconds with the naked eye (1600) to microarcseconds with VLBI and space-based astrometry (2020). Each order-of-magnitude improvement required new methods, new instruments, and new institutional frameworks.}
  \label{fig:historical-precision-evolution}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{generated/ch25-international-cooperation}
  \caption{Timeline of international scientific cooperation: from the Metre Convention (1875) through the Meridian Conference (1884) to modern redefinitions of SI units (2016). Each step represented increasing global coordination in scientific standards.}
  \label{fig:international-cooperation}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{generated/ch25-standards-infrastructure}
  \caption{The invisible infrastructure of global standards: a pyramid of layers from fundamental SI units at the base, through geodetic reference frames and time standards, to navigation systems and daily applications. Greenwich's contributions span multiple layers of this stack.}
  \label{fig:standards-infrastructure}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{generated/ch25-greenwich-legacy}
  \caption{Greenwich's enduring legacy. The Observatory's historical achievements, in circles, radiate from the institution itself; the modern systems that continue them, in hexagons, form the outer ring. From the Prime Meridian to \textsc{gps}, from the \emph{Nautical Almanac} to very-long-baseline interferometry, the foundations laid at Greenwich still carry the infrastructure of global coordination.}
  \label{fig:greenwich-legacy}
\end{figure}
