...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{generated/ch25-international-cooperation}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{generated/ch25-greenwich-legacy}
  \caption{Greenwich's enduring legacy: the Observatory's historical achievements (orange) radiate outward to modern continuations (green). From the Prime Meridian to GPS, from the Nautical Almanac to VLBI, the foundations laid at Greenwich continue to support the infrastructure of global civilization.}
