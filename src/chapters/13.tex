...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{generated/ch13-transit-circle-schematic}
  \caption{Schematic of the Airy transit circle. The telescope rotates about a horizontal east-west axis resting on precision V-bearings. A graduated circle allows altitude readings, while the reticule (inset) provides the reference for timing star transits across the meridian.}
  \label{fig:transit-circle-schematic}
\end{figure}
...
\[
  \delta = \phi + (90^{\circ} - h_{\text{true}}) \cos(\text{latitude})
\]
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{generated/ch13-personal-equation}
  \caption{The personal equation: systematic timing differences between observers. Airy found that he recorded transit times approximately 0.3 seconds earlier than his assistant. Both readings must be corrected to obtain the true transit time.}
  \label{fig:personal-equation}
\end{figure}
...
\begin{itemize}
  ...
  \item Altitude of transit: $63^{\circ} 15' 22''$ (read from graduated circle)
  \item Mean of reading microscope readings: $63^{\circ} 15' 24''$ (more precise; reading microscopes averaged)
  \item Observatory latitude: $\phi = 51^{\circ} 28' 40''$
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\linewidth}{llX}
    ...
    Thermal drift & $\pm 0.1''$ to $0.3''$ per $1^{\circ}$C & Significant over long exposure \\
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.75\textwidth]{generated/ch13-error-budget}
  \caption{Error budget for Airy transit circle observations. Atmospheric turbulence and refraction uncertainty dominated the error budget, with observer-related errors largely eliminated through the personal equation correction.}
  \label{fig:airy-error-budget}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{generated/ch13-precision-evolution}
  \caption{The evolution of positional astronomy precision from Tycho Brahe to the Gaia satellite. Airy's transit circle achieved sub-arcsecond precision, representing more than two orders of magnitude improvement over Tycho's instruments.}
  \label{fig:precision-evolution}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.75\textwidth]{generated/ch13-prime-meridian-offset}
  \caption{The 102-meter offset between the historic Airy Meridian (the brass line at Greenwich) and the modern WGS84 Prime Meridian used by GPS. The discrepancy arises from improved measurements of Earth's gravitational field and the choice of reference ellipsoid.}
  \label{fig:prime-meridian-offset}
\end{figure}
