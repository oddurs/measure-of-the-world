...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{generated/ch21-pendulum-physics}
  \caption{Pendulum physics. The restoring torque is proportional to displacement for small angles, producing simple harmonic motion with period $T = 2\pi\sqrt{L/g}$, independent of mass and amplitude.}
  \label{fig:chronometer-pendulum-physics}
\end{figure}
...
where $\theta_0$ is the maximum angular displacement in radians and $T_0 = 2\pi\sqrt{L/g}$ is the period for infinitesimal oscillations. The correction grows with the square of amplitude. If a pendulum oscillates with amplitude $\theta_0 = 10^{\circ}$ (a moderately vigorous swing), the $(\theta_0^2/16)$ term equals $(0.175)^2/16 \approx 0.0019$, or about two seconds per day—a significant error for a clock meant to run with second-level precision.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.55\textwidth]{generated/ch21-gridiron-pendulum}
  \caption{The gridiron pendulum. Alternating brass and steel rods expand in opposite directions with temperature. When properly proportioned, the bob's position remains constant despite thermal expansion.}
  \label{fig:gridiron-pendulum}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.6\textwidth]{generated/ch21-balance-wheel}
  \caption{The balance wheel and hairspring. The wheel oscillates against the torsional restoring force of the spiral hairspring. Period $T = 2\pi\sqrt{I/\kappa}$ depends on moment of inertia and spring constant, not orientation.}
  \label{fig:balance-wheel}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\textwidth]{generated/ch21-escapement-types}
  \caption{Three escapement mechanisms. The verge escapement produces recoil, causing timing variations. The deadbeat escapement eliminates recoil. The detent escapement is nearly frictionless, ideal for marine chronometers.}
  \label{fig:escapement-types}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.75\textwidth]{generated/ch21-fusee-mechanism}
  \caption{The fusée mechanism. A chain connects the mainspring barrel to a cone-shaped pulley. As the spring unwinds and torque decreases, the chain moves to a larger radius on the cone, maintaining constant output torque.}
  \label{fig:fusee-mechanism}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{generated/ch21-clock-precision-evolution}
  \caption{Evolution of timekeeping precision. From medieval verge escapements losing minutes per day to atomic clocks losing microseconds per year, precision improved by a factor of $10^{10}$ over seven centuries.}
  \label{fig:clock-precision-evolution}
\end{figure}
