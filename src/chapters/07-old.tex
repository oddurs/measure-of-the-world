...
\begin{itemize}
  \item \textsc{£10,000}: A method determining longitude to within \textsc{60 nautical miles} after sailing from Britain to the West Indies
  \item \textsc{£15,000}: A method determining longitude to within \textsc{40 nautical miles}
  \item \textsc{£20,000}: A method determining longitude to within \textsc{30 nautical miles}
\end{itemize}
...
So a method solving for longitude at the highest level of the Act needed to determine the time at Greenwich (or any fixed reference meridian) to within roughly \textsc{2.5 to 3 minutes}. The 60-nautical-mile threshold required only $\Delta t \approx 5$ minutes. These are the numbers that would drive technological innovation for the next seventy years.
