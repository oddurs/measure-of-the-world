...
\begin{figure}[htbp]
  ...
  \caption{John Flamsteed (1646--1719), the first Astronomer Royal. Portrait after Thomas Gibson, c.~1712.}
...
\begin{figure}[htbp]
  ...
  \caption{One of Thomas Tompion's year-going clocks, commissioned by Jonas Moore for the Royal Observatory in 1676. The 13-foot pendulum provided unprecedented accuracy for timing stellar transits.}
