...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.4\textwidth]{photos/ch02-john-flamsteed}
  \caption{John Flamsteed (1646--1719), the first Astronomer Royal. Portrait by Thomas Gibson, 1712 (Royal Society RS.9346). ``After'' would denote a later copy by another hand; this is the original.}
  \label{fig:john-flamsteed}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{photos/ch02-flamsteed-house}
  \caption{Flamsteed House, the original Royal Observatory building designed by Christopher Wren and completed in 1676. The distinctive octagonal turret housed the Octagon Room where Flamsteed made his observations. Photograph by Acabashi, CC BY-SA 4.0, via Wikimedia Commons.}
  \label{fig:flamsteed-house}
\end{figure}
...
What Flamsteed inherited came largely from Jonas Moore's generosity. Moore had commissioned two exceptional pendulum clocks from Thomas Tompion,\index{Tompion, Thomas}\index{clocks!pendulum} the finest horologist in England. These were masterpieces: clocks accurate to within ten or fifteen seconds per day, mounted on the ground floor with long pendulums hanging through carefully designed voids to achieve isolation from vibration.\footnote{Tompion's clocks are documented in \textcite{Betts1978}. One of the clocks survives at the National Maritime Museum, Greenwich. Specifications: a 13-foot pendulum regulated each clock's swing; the mechanism used a dead-beat escapement of the kind Tompion was then developing, and had no temperature compensation of any sort.} With these clocks, Flamsteed could time observations to a precision previously unimaginable.

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.45\textwidth]{photos/ch02-tompion-clock}
  \caption{A year-going clock at the Royal Observatory, of the type Jonas Moore commissioned from Thomas Tompion in 1676. The 13-foot pendulum gave unprecedented accuracy for timing stellar transits. The object photographed carries a 1737 replacement case and a 1972 replica dial. Photograph by Bin im Garten, 2010, CC BY-SA 3.0.}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.55\textwidth]{generated/ch02-mural-arc-principle}
  \caption{The principle of the mural arc. A quarter-circle graduated scale, mounted permanently in the meridian plane, measures a star's altitude as it crosses the north-south line. The transit time (from the pendulum clock) gives right ascension; the altitude reading gives declination.}
  \label{fig:mural-arc-principle}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.75\textwidth]{generated/ch02-catalog-precision}
  \caption{Positional accuracy of major star catalogs through history. Flamsteed's catalog achieved approximately four times the precision of Tycho Brahe's work, itself the best of the pre-telescopic era. This improvement was essential for the lunar distance method of determining longitude.}
  \label{fig:catalog-precision}
\end{figure}
