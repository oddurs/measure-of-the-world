...
\section{The Instrument Maker's Workshop: London, Circa 1670}
...
\section{The Astronomer's Toolkit: What Existed}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lrrl}
    ...
    \midrule
    Astrolabe & $\pm 30'$ & Best case; influenced by scale fineness \\
    Cross-staff & $\pm 20'$ & Geometry-based; good in trained hands \\
    Backstaff & $\pm 15'$ & Standard aboard ship; avoids sun-staring \\
    Quadrant (hand-divided) & $\pm 5'$ & Depends on craftsman; Tycho achieved this \\
    Quadrant (with vernier) & $\pm 30''$ & Rare; requires exceptional skill \\
    Pendulum clock & $\pm 10\mathrm{s}$ & On land; useless at sea \\
    Foliot clock & $\pm 15\mathrm{m}$ & Before pendulum; terrestrial only \\
    \bottomrule
  \end{tabular}
\end{table}
