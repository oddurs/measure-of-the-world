...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{generated/ch06-pendulum-physics}
  \caption{Pendulum mechanics. The restoring force $-mg\sin\theta$ drives oscillation. For small angles, this yields simple harmonic motion with period dependent only on length and gravity.}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{generated/ch06-temperature-error}
  \caption{Temperature sensitivity of pendulum clocks. Left: accumulated daily error increases linearly with temperature change for an uncompensated brass pendulum. Right: comparison of compensation methods showing the dramatic improvement achieved by gridiron and mercury pendulums.}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{generated/ch06-gravity-latitude}
  \caption{Gravity variation with latitude. Left: gravitational acceleration increases from equator to pole due to Earth's oblateness and rotation. Right: a clock calibrated in London loses time in the tropics (where gravity is weaker) and gains time near the pole.}
  \label{fig:gravity-latitude}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{generated/ch06-ship-motion}
  \caption{The pendulum problem at sea. Left: ship acceleration creates a fictitious force that tilts the effective gravity vector. Right: in rough conditions, this constant tilting renders the pendulum useless as a timekeeping element.}
  \label{fig:ship-motion}
\end{figure}
