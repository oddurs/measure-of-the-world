...
\begin{figure}[htbp]
  ...
  \caption{The Airy Transit Circle (1851) in its observing configuration. The 8-inch refractor rotates on an east-west axis between stone piers, with 6-foot graduated circles on each end. The telescope points through a roof slit aligned precisely north-south, observing stars as they cross the meridian.}
