...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{generated/ch22-transit-instrument}
  \caption{A transit instrument showing the key components: horizontal east-west axis supported by precision pivots on stone piers, the telescope rotating only in the meridian plane, graduated circles for reading altitude, and crosshairs in the field of view for timing star transits.}
  \label{fig:transit-instrument}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.75\textwidth]{generated/ch22-mural-circle}
  \caption{A mural circle mounted on a meridian wall, showing the full graduated circle (360°), a telescope pivoting at the center, and a reading microscope for precise angle measurement. The index marks the altitude of the star being observed.}
  \label{fig:mural-circle}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{generated/ch22-airy-transit-circle}
  \caption{The Airy Transit Circle, erected 1850 and first used 4 January 1851, in its observing configuration. The 8-inch refractor rotates on an east-west axis between stone piers, with 6-foot graduated circles on each end. The telescope points through a roof slit aligned precisely north-south, observing stars as they cross the meridian.}
  \label{fig:airy-transit-circle}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.6\textwidth]{generated/ch22-pivot-bearing}
  \caption{Cross-section of a precision pivot and bearing. The cylindrical pivot, ground to tolerances of less than 0.001 inch, rests in a V-shaped bearing at two contact points. A thin oil film reduces friction while maintaining precise positioning. Any irregularity in the pivot shape introduces systematic pointing errors.}
  \label{fig:pivot-bearing}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\textwidth]{generated/ch22-level-and-collimator}
  \caption{Left: A striding level, which straddles the telescope axis to measure any departure from horizontal. The spirit bubble moves proportionally to the axis tilt. Right: A collimating telescope produces parallel light rays that simulate an infinitely distant star, used to verify optical alignment.}
  \label{fig:level-and-collimator}
\end{figure}
...
Suppose an observer at Greenwich on the evening of 15 March 1850 observes the star Vega (right ascension $\approx 18^{\mathrm{h}}36^{\mathrm{m}}56^{\mathrm{s}}$, declination $+38^{\circ}47'$) using the transit circle.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\textwidth]{generated/ch22-meridian-observation}
  \caption{Sequence showing a transit observation: as a star drifts across the field of view, the observer records the time at which it crosses each vertical wire. The transit time is taken as the mean of all wire-crossing times, eliminating personal reaction time errors.}
  \label{fig:meridian-observation}
\end{figure}
...
For the declination: The level on the east-west axis shows the axis is tilted $0.2$ divisions, corresponding to $+0.02^{\circ}$. The observed altitude at transit is $51^{\circ}43.2'$. The declination is computed as:

$\delta = 90^{\circ} - \text{zenith distance} = 90^{\circ} - (\text{altitude correction})$

The computed declination is $\delta = 38^{\circ}47.1'$, which agrees with the catalog value to within 0.1 arcminute. The observation is consistent.
