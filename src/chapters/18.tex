...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{generated/ch18-sidereal-vs-solar}
  \caption{Sidereal versus solar day. A sidereal day (23h 56m 04s) is the time for Earth to rotate once relative to the distant stars. A solar day (24h) requires additional rotation to account for Earth's orbital motion around the Sun.}
  \label{fig:sidereal-vs-solar}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{generated/ch18-ut-variants}
  \caption{The hierarchy of Universal Time variants. UT0 is raw observational time; UT1 corrects for polar motion; UT2 adds seasonal smoothing. TAI (atomic time) and UTC are derived from atomic clocks rather than Earth's rotation.}
  \label{fig:ut-variants}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{generated/ch18-atomic-second}
  \caption{The SI second is defined by the hyperfine transition of cesium-133. The frequency of 9,192,631,770 Hz corresponds to the energy difference between the F=3 and F=4 hyperfine states.}
  \label{fig:atomic-second}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{generated/ch18-leap-second}
  \caption{The leap second mechanism. When the difference between UT1 (Earth rotation) and UTC (atomic time) approaches 0.9 seconds, a leap second is inserted, adding 23:59:60 to the clock sequence.}
  \label{fig:leap-second}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.6\textwidth]{generated/ch18-timekeeping-stack}
  \caption{The layers of time abstraction, from apparent solar time (human perception) to UTC (atomic time with leap second corrections). Each layer adds precision and removes dependence on local observation.}
  \label{fig:timekeeping-stack}
\end{figure}
