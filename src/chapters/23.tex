...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{generated/ch23-skyglow-physics}
  \caption{How light pollution creates skyglow: artificial light from street lamps and buildings is scattered by atmospheric particles, creating a diffuse glow that obscures faint stars. The sky background brightness increases, reducing the limiting magnitude visible to observers.}
  \label{fig:skyglow-physics}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{generated/ch23-limiting-magnitude}
  \caption{The relationship between sky brightness and limiting magnitude. As artificial light pollution increases (moving left on the chart), the faintest stars visible to the naked eye become progressively brighter. By the 1950s, Greenwich had reached conditions typical of urban city centers.}
  \label{fig:limiting-magnitude}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\textwidth]{generated/ch23-site-comparison}
  \caption{Comparison of observing conditions at Greenwich (left) and Herstmonceux (right) in the late 1950s. While Greenwich suffered heavy skyglow that obscured all but the brightest stars, the rural Sussex site offered dark skies where the Milky Way was visible.}
  \label{fig:site-comparison}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{generated/ch23-canary-islands-sites}
  \caption{Observatory sites in the Canary Islands. Roque de los Muchachos on La Palma (2426m) hosts the Isaac Newton Telescope and the William Herschel Telescope. The sites benefit from stable atmosphere above the inversion layer, minimal light pollution, and over 300 clear nights per year.}
  \label{fig:canary-islands-sites}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\textwidth]{generated/ch23-observatory-migration}
  \caption{Timeline showing the Royal Observatory's migration from Greenwich, driven by increasing light pollution. The orange shading indicates the growth of artificial lighting in the London area throughout the 20th century.}
  \label{fig:observatory-migration}
\end{figure}
