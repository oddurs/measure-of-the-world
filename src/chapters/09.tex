...
At Kew, on a spring morning in 1772, an old man placed a small watch in the palm of a king. John Harrison\index{Harrison, John}\index{chronometer} was seventy-eight years old; King George III\index{George III} held the H5\index{H5 chronometer}---a masterpiece of horology no larger than a modern wristwatch. For ten weeks that May, June and July, the King observed it daily against the known motions of celestial bodies at his own observatory. Its rate held to within a third of a second a day. ``By God, Harrison,'' the King declared, ``I will see you righted!'' Here was the final vindication of a forty-year quest that had consumed a craftsman, frustrated a Board, and challenged every assumption about how the problem of longitude should be solved.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{generated/ch09-chronometer-evolution}
  \caption{The evolution of Harrison's chronometers from H1 (1735) to H5 (1770). The 18-year development of H3 reflects the difficulty of solving the temperature compensation problem.}
  \label{fig:chronometer-evolution}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{generated/ch09-linked-balance}
  \caption{The linked balance principle. Two balance wheels oscillate in anti-phase on a shared axis, canceling the effects of external vibrations on the timekeeping mechanism.}
  \label{fig:linked-balance}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{generated/ch09-temperature-compensation}
  \caption{Bimetallic temperature compensation. Left: a brass-steel bimetallic strip bends as temperature changes because the metals have different expansion coefficients. Right: this principle reduces the temperature sensitivity of the chronometer's rate by a factor of 25.}
  \label{fig:temperature-compensation}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.75\textwidth]{generated/ch09-trial-performance}
  \caption{Sea trial results for Harrison's chronometers. H4's Jamaica trial (1762) achieved an error of only 5.1 seconds over 81 days---far exceeding the Longitude Act's requirements.}
  \label{fig:trial-performance}
\end{figure}
...
H5 was completed in 1770 and handed to the Board for official testing. The result was the trial of May to July 1772 with King George III at Kew, already recounted. The King's own verification—observing H5 directly against the motions of the stars over ten weeks—carried an authority that official Board testing could not. ``By God, Harrison, I will see you righted!''
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.55\textwidth]{generated/ch09-error-sources}
  \caption{Approximate contributions to H4's residual error of 5.1 seconds. Thermal lag and escapement friction were the dominant sources, with bearing wear and material creep contributing smaller amounts.}
  \label{fig:error-sources}
\end{figure}
