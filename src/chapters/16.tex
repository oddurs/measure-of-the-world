...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{generated/ch16-time-ball-mechanism}
  \caption{The Greenwich time ball mechanism. At 1:00 PM daily, an electrical signal releases the ball, which drops visibly to ships on the Thames, enabling chronometer synchronization.}
  \label{fig:time-ball-mechanism}
\end{figure}
...
where $\theta$ is the angle off the vertical. For $r = 1000 \text{ m}$ and $\theta = 45^{\circ}$, this yields $\Delta t \approx 2.4 \text{ microseconds}$—still small, but adding to reaction-time uncertainty.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{generated/ch16-error-budget-timeball}
  \caption{Error budget for time ball observation. The observer's reaction time dominates all other error sources, limiting practical accuracy to approximately 0.1 seconds.}
  \label{fig:error-budget-timeball}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{generated/ch16-galvanic-network}
  \caption{The Observatory's galvanic network distributed simultaneous time signals from the master clock to instruments across the grounds and beyond to external locations.}
  \label{fig:galvanic-network}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\textwidth]{generated/ch16-telegraph-vs-radio}
  \caption{Telegraph versus radio time distribution. Telegraph required physical wire connections; radio broadcasts reach all receivers within range without infrastructure.}
  \label{fig:telegraph-vs-radio}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{generated/ch16-time-distribution-hierarchy}
  \caption{The modern hierarchy of time distribution, from atomic standards at national metrology institutes through satellite and terrestrial networks to end users.}
  \label{fig:time-distribution-hierarchy}
\end{figure}
...
\[
  r = \frac{d}{\cos(30^{\circ})} = \frac{500 \text{ m}}{\cos(30^{\circ})} \approx 577 \text{ m}.
\]
...
\[
  \Delta t_{\text{parallax}} \approx \frac{d \sin(20^{\circ})}{c} = \frac{500 \times 0.342}{3 \times 10^8} \approx 0.6 \text{ microseconds}.
\]
