...
\[
  d_{\odot} \approx \frac{206265''}{\pi_{\odot}} \, R_{\oplus},
\]
where the quotient is in Earth radii, because the solar parallax is by definition the angle the Earth's radius subtends at the Sun.

With a measured parallax of $\pi_{\odot} \approx 8.8$ arcseconds, close to the modern value of $8.794$, the distance becomes
\[
  d_{\odot} \approx \frac{206265}{8.8} \, R_{\oplus} \approx 23{,}440 \, R_{\oplus} \approx 1.50 \times 10^{8} \text{ km},
\]
taking $R_{\oplus} = 6378$ km. This is the astronomical unit: the quantity the whole exercise exists to find, and the one that converts every angular measurement in the solar system into a distance.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{generated/ch11-halley-comet-orbit}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{generated/ch11-halley-life-table}
...
To illustrate the method of transit parallax and its application to determining the solar distance, consider the Venus transit of 1761. Two observers separated by a known baseline measure the transit simultaneously. Observer $A$ at Greenwich ($51.5^{\circ}$ N) records the contact time $t_A = 05^{\text{h}} 21^{\text{m}} 47^{\text{s}}$ (Greenwich Mean Time). Observer $B$ at Tobolsk (Siberia, $58.3^{\circ}$ N, $68.2^{\circ}$ E) records contact at $t_B = 08^{\text{h}} 41^{\text{m}} 06^{\text{s}}$ (local time, which translates to $05^{\text{h}} 41^{\text{m}} 06^{\text{s}}$ GMT).
...
The 1761 transit was observed from stations scattered deliberately across the globe: Nevil Maskelyne on St Helena, Charles Mason and Jeremiah Dixon at the Cape of Good Hope, Jean-Baptiste Chappe d'Auteroche at Tobolsk in Siberia, Alexandre-Guy Pingr\'e on Rodrigues in the Indian Ocean, and William Hirst at Madras.\footnote{Each published an account in \emph{Philosophical Transactions} volume 52 for 1761. Maskelyne reached St Helena but was largely clouded out, which is a fair measure of the enterprise: an expedition could be mounted, funded and sailed halfway around the world, and still be defeated by a morning's weather. Guillaume Le Gentil fared worse still: he was at sea off Pondicherry on the day of the 1761 transit, unable to land and unable to measure from a moving deck, waited eight years in the Indian Ocean for the 1769 transit, and was clouded out on the morning it came. Eleven years, two transits, no observation.} The reductions yielded a solar parallax of approximately $8.76$ arcseconds. That corresponds to an astronomical unit of
\[
  1 \text{ AU} = \frac{206265''}{8.76''} \, R_{\oplus} \approx 23{,}550 \, R_{\oplus} \approx 1.50 \times 10^{8} \text{ km},
\]
within half a per cent of the modern value of $1.496 \times 10^{8}$ km, or $1.496 \times 10^{11}$ metres.\footnote{The coordination of the two campaigns, across rival nations and through a war, was an institutional achievement as much as a scientific one. Contemporary tallies of observers and stations vary and none is given here, because no count reachable in preparing this book could be reconciled with another. See \textcite{Chapin1995}, Chapters 6--9, for a comprehensive account of the transit expeditions and their scientific aftermath.}
