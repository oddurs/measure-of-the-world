...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{generated/ch20-chromatic-aberration}
  \caption{Chromatic aberration in a simple lens. Different wavelengths focus at different distances because the refractive index varies with wavelength. Blue light bends more than red, causing color fringing in the image.}
  \label{fig:refractor-chromatic-aberration}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{generated/ch20-achromatic-doublet}
  \caption{The achromatic doublet. A converging crown glass lens and a diverging flint glass lens are combined. The flint's higher dispersion cancels the crown's chromatic aberration, bringing all colors to a common focus.}
  \label{fig:refractor-achromatic-doublet}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{generated/ch20-reflector-design}
  \caption{Newton's reflecting telescope design. Parallel light enters the tube, reflects off the parabolic primary mirror to a flat secondary mirror, and exits through an eyepiece mounted on the side of the tube. All wavelengths focus at the same point.}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\textwidth]{generated/ch20-optical-aberrations}
  \caption{Common optical aberrations. Spherical aberration causes edge rays to focus closer than center rays. Coma produces comet-shaped blur for off-axis points. Astigmatism creates two perpendicular focal lines instead of a point.}
  \label{fig:optical-aberrations}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{generated/ch20-mount-comparison}
  \caption{Comparison of altazimuth and equatorial mounts. The altazimuth mount rotates about vertical and horizontal axes; both must move to track a star. The equatorial mount's polar axis is aligned with Earth's rotation axis, requiring only a single uniform rotation to track.}
  \label{fig:mount-comparison}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{generated/ch20-telescope-evolution}
  \caption{Evolution of telescope aperture from 1668 to 1908. Reflectors (red) could be built larger than refractors (blue), but both types grew steadily as optical and mechanical engineering improved.}
  \label{fig:telescope-evolution}
\end{figure}
