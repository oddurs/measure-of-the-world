...
In a house at Ludlow, Shropshire, in the 1780s, a woman named Mary Edwards sat at a table with pen, ink and freshly printed ephemerides. She held no university degree and was not a member of the Royal Society. The work in front of her was published under her husband's name. The Reverend John Edwards was the computer of record for the \emph{Nautical Almanac}; a good deal of the computing was hers, and the Board of Longitude did not know it until he died in 1784 and she told them. They employed her in her own name for the next thirty years. Her task on any given month was to compute lunar positions that another hand, in another town, was computing independently from the same tables, and neither of them would learn whether the two sets agreed until a third man, the comparer, set them side by side. This was how the greatest navigational tool of the 18th century was built—not by a single genius, but by a distributed network of human minds, each working in isolation, each checked against the others. When they agreed, Maskelyne kept them. When they diverged wildly, he discarded both and assigned the task to a third. The Nautical Almanac, published annually starting in 1767, was the first computational enterprise of its kind: a machine built of people.
...
Maskelyne's solution was audacious: he would create a permanent corps of computers. These would be educated individuals—clergymen, schoolmasters, surveyors, gentlemen with mathematical skill but limited employment prospects—recruited from around the country. Each would receive a stipend and assignments of calculations. Each month was computed twice, by two men working independently in different towns, and a third, the comparer, reconciled the two sets and prepared the copy for the printer. Where the pair agreed, the value stood; where they diverged, the comparer found which was wrong.\footnote{\textcite{Croarken2002} documents the emergence of Maskelyne's computer network. The network included Mary Edwards at Ludlow (mentioned in our opening vignette), William Wales, several clergy in Yorkshire and Lincolnshire, and others. Most were never famous; some were hired by Maskelyne for only a few years.}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{generated/ch10-computer-network}
  \caption{Maskelyne's distributed computer network. Human computers across Britain performed calculations independently, with results compared at Greenwich to detect errors.}
...
Many were clergymen. An Anglican vicar or curate might have a few hours each week free from parish duties, and for a modest income he could contribute to the \emph{Nautical Almanac}. Others kept different posts: schoolmasters, surveyors, even physicians. And the work was not always done by the person the Board paid. Mary Edwards computed at Ludlow under her husband's name until his death in 1784, was then taken on in her own, and continued until she died in 1815, supporting herself and her daughters on the income. Far from being a gentlewoman pursuing an interest, she was a professional whose work had been invisible because it was published under someone else's name.\footnote{\textcite{CroarkenEdwards2003} reconstructs Mary Edwards's career from the Board of Longitude papers and the Ludlow parish records. Hers is the clearest surviving evidence that the computing establishment was larger than the Board's payment ledgers show.}
...
The Nautical Almanac, whose first edition was for the year 1767 and carried an imprint date of 1766 though copies did not reach the Commissioners until 6 January 1767, contained several types of tables:
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{generated/ch10-almanac-structure}
  \caption{Contents of the Nautical Almanac. The publication provided comprehensive astronomical data computed for every few hours throughout the year.}
  \label{fig:almanac-structure}
\end{figure}

\section{The Navigator's Procedure}

How did a navigator actually use the Nautical Almanac? The procedure was demanding but systematic, consisting of roughly six steps:\footnote{\textcite{Maskelyne1763}, the \emph{British Mariner's Guide}, provides the authoritative contemporary description. \textcite{Howse1980}, Chapter 8, summarizes the method with modern notation.}
...
\[
  \Delta t = \frac{\Delta\text{distance}}{0.55^{\circ}/\text{hour}} \quad \Rightarrow \quad \Delta\lambda = \Delta t \times 15^{\circ}/\text{hour}.
\]
...
The entire procedure, from observation to final result, might occupy 2--3 hours of the navigator's time, assuming competence and access to the necessary tables. Compare this to consulting a marine chronometer: assuming the chronometer had been set to Greenwich time and had not gained or lost appreciably, the navigator could simply note the chronometer time and combine it with his latitude to determine position in minutes.\footnote{\textcite{Maskelyne1763}, pp. 112--125, provides worked examples; modern expositions appear in \textcite{Howse1980}, pp. 180--195.}

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{generated/ch10-navigator-procedure}
  \caption{The navigator's six-step procedure for determining longitude by lunar distance. The clearing step, requiring 30--60 minutes of calculation, was the major bottleneck.}
  \label{fig:navigator-procedure}
\end{figure}
...
Logarithms (recently popularized by John Napier's 1617 work and improved by subsequent mathematicians) allowed multiplication and division to be replaced by table lookups and addition/subtraction. To compute $\sin(45.3^{\circ}) \times \cos(22.1^{\circ})$, a computer would:
\begin{enumerate}
\item Look up $\log \sin(45.3^{\circ})$ in a table
\item Look up $\log \cos(22.1^{\circ})$ in a table
...
Moreover, the Nautical Almanac was not limited to lunar distances. It provided solar positions, lunar positions, stellar positions, and Jupiter's satellite phenomena. Astronomers used the Almanac to plan observations, predict phenomena, and determine latitude and longitude simultaneously. Military observatories used it. Civilian astronomers used it. The investment in computing and printing the Nautical Almanac served multiple constituencies.\footnote{\textcite{Croarken2003}, Chapter 5, discusses the Nautical Almanac's expansion of scope in the 19th century, including additions for scientific navigation, astronomical prediction, and eventually the distribution of time signals.}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{generated/ch10-chronometer-vs-almanac}
  \caption{Comparison of the chronometer and Nautical Almanac methods. Each had distinct advantages: the chronometer was faster and more accurate, but the Almanac was accessible to every ship regardless of budget.}
  \label{fig:chronometer-vs-almanac}
\end{figure}
