...
The maximum effect occurs near the equinoxes (when $\sin 2\lambda = 1$), giving $E_{\text{obliq}} \approx -\tan^2(11.7^{\circ}) \approx -0.043$ radians $\approx \SI{-9.9}{\minute}$. This is larger in magnitude than the eccentricity effect.

\section{The Total Equation of Time}

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{generated/ch15-eccentricity-effect}
  \caption{The eccentricity effect: Earth moves faster at perihelion (January) than at aphelion (July), causing the Sun to appear to move faster or slower along the ecliptic.}
  \label{fig:eccentricity-effect}
\end{figure}

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{generated/ch15-obliquity-effect}
  \caption{The obliquity effect: the Sun's motion along the tilted ecliptic projects differently onto the celestial equator at different times of year, with near-equinox motion amplified.}
  \label{fig:obliquity-effect}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\textwidth]{generated/ch15-equation-of-time}
  \caption{The equation of time over a year, showing the eccentricity component (dashed blue), obliquity component (dashed red), and total (solid black). Maximum deviation reaches approximately 16 minutes in early November.}
  \label{fig:equation-of-time}
\end{figure}

\section{The Analemma: The Figure-Eight in the Sky}

If an observer marks the position of the Sun at the same clock time each day for a full year, the plotted positions trace a figure-eight pattern in the sky called the analemma. The vertical extent of the analemma (north-south extent) is due to the obliquity of the ecliptic: the Sun moves from declination $+23.44^{\circ}$ at the summer solstice to $-23.44^{\circ}$ at the winter solstice. The horizontal extent (east-west) is due to the equation of time: the Sun is sometimes ahead of clock time, sometimes behind.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.55\textwidth]{generated/ch15-analemma}
  \caption{The analemma: the figure-eight pattern traced by the Sun's position when photographed at the same clock time each day throughout the year. The vertical extent reflects seasonal changes in declination; the horizontal extent reflects the equation of time.}
  \label{fig:analemma}
\end{figure}

\section{A Worked Example: The Equation of Time on May 12}

Suppose we wish to calculate the equation of time for May 12, a date near one of the secondary maxima. First, we convert the date to the mean anomaly $M$. The mean anomaly increases linearly from 0 at perihelion (January 3, year 2000 epoch) to $360^{\circ}$ over the course of the year. Dividing the year into 365.25 days:

\[
  M = 360^{\circ} \times \frac{\text{day of year} - 2}{365.25} = 360^{\circ} \times \frac{132 - 2}{365.25} \approx 130.1^{\circ}.
\]
...
\[
  \lambda = M + 2e \sin M + \cdots \approx 2.27 + 2(0.0167) \sin(2.27) \approx 2.27 + 0.0278 \approx 2.298 \text{ rad} \approx 131.7^{\circ}.
\]
...
Wait: this gives a net value of $-1.6 + 2.4 = +0.8$ minutes, which is small. Let me recalculate more carefully. The ecliptic longitude for May 12 is approximately $52^{\circ}$ beyond the vernal equinox, so $\lambda = 90^{\circ} + 52^{\circ} = 142^{\circ}$. Actually, I should use the more accurate formula. At May 12 (day 132), $M \approx 130.1^{\circ}$ and 
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{generated/ch15-mean-vs-apparent}
  \caption{The two solar times set against each other. A clock keeping mean solar time divides the day into equal intervals; a sundial keeping apparent solar time does not, because the Sun's apparent motion along the ecliptic is not uniform. The offset between their noons is the equation of time, and on most days of the year it is not zero.}
  \label{fig:mean-vs-apparent}
\end{figure}
