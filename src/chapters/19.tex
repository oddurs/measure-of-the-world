...
So rotating the mirror by $\beta$ changes the outgoing ray angle by $2\beta$. For the navigator, this means that a $1°$ rotation of the index mirror produces a $2°$ change in the angle between horizon and star as viewed through the telescope. An observer reading an arc directly graduated can measure angles up to twice the arc's full span. A $60°$ arc measures angles up to $120°$—sufficient to encompass the angular separation between Sun and Moon at favorable lunar distances.\footnote{\textcite{Maskelyne1763} explains the advantage of the sextant's 120° range for the lunar distance method. See also Section~\ref{sec:lunar-distance-geometry} of Chapter~\ref{ch:lunar-distance-method}.}
